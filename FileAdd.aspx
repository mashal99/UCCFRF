<%@ Page Title="Add Document" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FileAdd.aspx.cs" Inherits="UCCFRFWebApp.FileAdd" %>
            ...
            <section id="addFileForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="FileUp" CssClass="col-md-2 control-label">Upload File</asp:Label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" OnClick="Upload" Text="Upload File" ID="Upload" CssClass="btn btn-default" />
                        </div>
                    </div>
                </div>
